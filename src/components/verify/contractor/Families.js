...
export default function Families({ selectedFamily }) {
  const extractedFamilyData = {
    name: selectedFamily.employerName ,
    state: selectedFamily.state ,
    district: selectedFamily.district,
    block: selectedFamily.block,
    contractorType: selectedFamily?.contractorType,
    employerPanTan: selectedFamily?.employerPanTan,
    employerRegistrationNo: selectedFamily?.employerRegistrationNo,
