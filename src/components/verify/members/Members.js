...
import formatDateDeepkak from "../../../utils/dateFormat";
                ...
                >
                  <Box style={{ textAlign: "center" }}>
                    <Typography variant="subtitle1">
                      {memberObject?.employmentType}
                    </Typography>
                  </Box>
                  <Box style={{ textAlign: "center" }}>
                    <Typography variant="subtitle1">
                      {memberObject.siteOwner}
                    </Typography>
                  </Box>
                  <Box style={{ textAlign: "center" }}>
                    <Typography variant="subtitle1">
                  ...
                  <Box style={{ textAlign: "center" }}>
                    <Typography variant="subtitle1">
                      {memberObject.workingDaysInMonths}
                    </Typography>
                  </Box>
                  <Box style={{ textAlign: "center" }}>
                    <Typography variant="subtitle1">
                      {memberObject?.employedFrom != "null" ? formatDateDeepkak(memberObject?.employedFrom) : "-"}
                    </Typography>
                  </Box>
                  <Box style={{ textAlign: "center", fontWeight : "500" }}>
                    {memberObject?.employedTill != "null" ? formatDateDeepkak(memberObject?.employedTill) : "-"}
