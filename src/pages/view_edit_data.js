...
const ViewData = () => {
  ...
  const handleFilterChange = ({ district, office, ward, village }) => {
    setSelectedDistrict(district);
    setSelectedMunicipality(office);
                  ...
                  <div style={{}}   >
                    ...
                    {selectedFamily?.employerDetails &&
                     ...
                     style={{ marginBottom: 8 }}
                        ...
                        >
                          {selectedFamily?.employerDetails?.map((k,i) => (

                     <Members memberObject={k} key={i} office={selectedFamily?.officeDetails} />
                          ))}
                   </Paper>
                     }</>}
                  </div>
